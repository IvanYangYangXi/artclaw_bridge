"""
artclaw_bridge CLI - 主入口
=====================

命令结构: artclaw_bridge <command> <subcommand> [options]

用法:
    artclaw_bridge skill create <name> [--category scene] [--software unreal_engine]
    artclaw_bridge skill generate "自然语言描述"
    artclaw_bridge skill test <name> [--dry-run]
    artclaw_bridge skill list [--category material]
    artclaw_bridge skill info <name>
    artclaw_bridge skill package <name>
    artclaw_bridge skill publish <name> [--target 01_team]
    artclaw_bridge skill install <source>
    artclaw_bridge skill uninstall <name>
    artclaw_bridge skill enable <name>
    artclaw_bridge skill disable <name>
    artclaw_bridge skill update <name>
"""

import argparse
import sys

from artclaw_bridge.commands import skill as skill_cmd


def main():
    parser = argparse.ArgumentParser(
        prog="artclaw_bridge",
        description="artclaw_bridge - AI-powered DCC Skill management CLI",
    )
